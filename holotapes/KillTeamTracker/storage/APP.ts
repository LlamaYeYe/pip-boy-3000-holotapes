...
(function () {
  ...
  function drawMenu(menuOptions: string[]): void {
    ...
    menuOptions.forEach((option: string | number, index) => {
  ...
  function drawTrackerBoard(): void {
  ...
  function menuLoad(menuOptions: string[], menuHeader: string): void {
    menuIndexSelected = 0;
  ...
  function statScroll(dir: number): void {
