...
(function () {
  ...
  let scene: HolotapeApp | null = null; // Current scene
  let pending: RadroachPendingScene | null = null; // Next scene queued
  ...
  const app = {
    ...
    // Go to scene
    go: function (file: string, params?: PipValue) {
